...
urlpatterns = [
    ...
    path('user-update-delete/<slug:username>/',views.user_update_delete, name='user-update-delete'),
    


    # only for current user (request.user)
    path('profile-user/', views.ProfileUserAPIView.as_view(), name="profile-user"),
